...
class Snake:
    def __init__(self, parent_screen):
        ...
        self.headup = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/headup.png').convert_alpha()
        self.headdown = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/headdown.png').convert_alpha()
        self.headright = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/headright.png').convert_alpha()
        self.headleft = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/headleft.png').convert_alpha()
        self.upright = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/upright.png').convert_alpha()
        self.upleft = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/upleft.png').convert_alpha()
        self.downright = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/downright.png').convert_alpha()
        self.downleft = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/downleft.png').convert_alpha()
        self.vertical = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/vertical.png').convert_alpha()
        self.horizontal = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/horizontal.png').convert_alpha()
        self.endup = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/endup.png').convert_alpha()
        self.enddown = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/enddown.png').convert_alpha()
        self.endright = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/endright.png').convert_alpha()
        self.endleft = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/endleft.png').convert_alpha()
        self.x = 330
        self.y = 330
...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.x = 110
        self.y = 110
        self.image = pygame.image.load('C:/Users/Dasadirs/PycharmProjects/Snake/ressources/snake_graphics/apple.png').convert_alpha()
...
class Game:
    ...
    def run(self):
        ...
        while not self.game_lost:
            ...
            if keys[pygame.K_UP] and self.snake.direction == 'up':
                self.speed = 0.1
            elif keys[pygame.K_DOWN] and self.snake.direction == 'down':
                self.speed = 0.1
